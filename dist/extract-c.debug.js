...
async function __wasmfs_opfs_get_size_access(ctx, accessID, sizePtr) {
  ...
  GROWABLE_HEAP_I32()[((sizePtr) >> 2)] = tempI64[0], GROWABLE_HEAP_I32()[(((sizePtr) + (4)) >> 2)] = tempI64[1]);
  wasmfsOPFSProxyFinish(ctx);
}
